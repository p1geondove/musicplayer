...
class AudioVisualizer:
    ...
    def get_spectrum(self, time_pos: float) -> np.ndarray:
        ...
        return (band_magnitudes / np.max(band_magnitudes)).astype(float)
    ...
    def draw_spectrum(self, time_pos: float):
        ...
        for i, magnitude in enumerate(self.get_spectrum(time_pos)):
